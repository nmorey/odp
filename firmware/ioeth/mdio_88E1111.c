...
{
#ifdef MDIO_DEBUG
  printf("[MDIO DEBUG] Call to mppa_eth_set_mdio_data  mppa_gpio[MDIO_GPIO_DEVICE] = 0x%x (0x%.8x).\n", mppa_gpio[MDIO_GPIO_DEVICE], value);
#endif
...
{
#ifdef MDIO_DEBUG
  printf("[MDIO DEBUG] Call to mppa_eth_mdio_read(%d, %u, %u, 0x%.8x).\n", phy, chip_id, reg, val);
#endif
...
{
#ifdef MDIO_DEBUG
  printf("[MDIO DEBUG] Call to mppa_eth_mdio_write(%d, %u, %u, 0x%.8x).\n", phy, chip_id, reg, val);
#endif
