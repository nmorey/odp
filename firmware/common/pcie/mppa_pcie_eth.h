...
/**
 * Address of `mppa_pcie_eth_control` structure (arbitrary but in smem)
 */
#define MPPA_PCIE_ETH_CONTROL_STRUCT_ADDR	0x1C200
 ...
 * `ring_buffer_addr` point either to RX ring entries (`mppa_pcie_eth_tx_ring_buff_entry`)
